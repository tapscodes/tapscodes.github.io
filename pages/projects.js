    ...
    return ( 
        <div>
            ...
            <ul>
                ...
                <ImageDescriptionBox href="https://github.com/tapscodes/MineSweeper" target="_blank" img_url="/Images/first_site.jpg" 
                ...
                <ImageDescriptionBox href="https://github.com/tapscodes/Speedre" target="_blank" img_url="/Images/first_site.jpg" 
                header = "Speedre" text="This is a completely original creation I made for my final project in my Udacity iOS course.
                It used an AI image recognition API from DeepAI to have the user guess what was in an image before the AI 'guessed'."/>

                <ImageDescriptionBox href="https://github.com/tapscodes/WWDC19" target="_blank" img_url="/Images/first_site.jpg" 
                ...
                <ImageDescriptionBox href="https://github.com/tapscodes/VirtualTourist" target="_blank" img_url="/Images/first_site.jpg" 
                ...
                <ImageDescriptionBox href="https://github.com/tapscodes/OnTheMap" target="_blank" img_url="/Images/first_site.jpg" 
                ...
                <ImageDescriptionBox href="https://github.com/tapscodes/Pitch-Perfect" target="_blank" img_url="/Images/first_site.jpg" 
                header = "Pitch Perfect" text="An iOS app that allows you to record audio and then pitch it up or down.
                This app was made during my Udacity course."/>

                <ImageDescriptionBox href="https://github.com/tapscodes/MeMe1and2" target="_blank" img_url="/Images/first_site.jpg" 
