...
export default function Home() {
  const skills = "Microsoft Azure | Snowflake | Java | C# | HTML | CSS | Javascript | React | Python | C++ | Git | NextJS | Swift | SQL | MIPS | Cloudflare | JavaFX | Visual Studio 2022 | Visual Studio Code | QT | C | Kotlin | PuTTy | Android Studio";
